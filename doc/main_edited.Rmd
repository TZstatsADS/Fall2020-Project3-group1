...
![Figure1](../figs/comparison_accuracy_auc.png)
![Figure2](../figs/comparison_train_time.png)
![Figure3](../figs/comparison_test_time.png)
...
The model alsp uses several parameters that can be cross-validated, such as "interaction.depth" and "distribution" were set to fit the needs of this situation. For example, "interaction.depth" was set 1 since our focus was to use decision trees and "distribution" was set to "binomial" since there are only two classes.  
...
```{r cv_vis_gbm_1,out.width = "65%", echo=FALSE}
# Mean Error
p1 = ggplot(
...
```{r cv_vis_gbm_2, out.width = "65%",echo=FALSE}
# Mean Error
# N.Trees = 600
...
```{r cv_vis_xgboost_1,out.width = "65%", echo=FALSE}
# Mean Error
# gamma = 0, lambda = 0.05
p1 = ggplot(
...
```{r cv_vis_xgboost_2, out.width = "65%",echo=FALSE}
# Mean Error
...
```{r cv_vis_svm, out.width = "65%",echo=FALSE}
...
+ mtry: this parameter is more expreience-related, so we set its value to be the default 500.
...
```{r cv_vis_rf, out.width = "65%",echo=FALSE}
...
```{r cv_vis_rfw_1, out.width = "65%",echo=FALSE}
# Mean Error
p1 = ggplot(
...
```{r cv_vis_rfw_2, out.width = "65%",echo=FALSE}
# Mean Error
# ntrees = 100
p1 <- ggplot(
...
# Results
```{r results_2, out.width = "65%",echo=FALSE}
...
ggsave(path = "../figs","comparison_train_time.png",width=4, height=3)
...
ggsave(path = "../figs","comparison_test_time.png",width=4, height=3)
```


```{r results_3,out.width = "65%", echo=FALSE}
...
ggplot(data=results_barplot,aes(x = model, y = value,fill=factor))+
  ...
  theme_minimal()
ggsave(path = "../figs","comparison_accuracy_auc.png",width=4, height=3)
```
