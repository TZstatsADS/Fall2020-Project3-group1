...
![comparison of training and testing time of 5 models](../figs/comparison_time.png)

![comparison of accuracy and AUC of 5 models](../figs/comparison_accu_auc.png)

```{r, echo=FALSE}
#read direct from the plots stored in the fig folder before training the data
...
p1 = ggplot(data=results,aes(x = as.factor(model), y = tm_train))+
  ...
  theme_minimal()+
  labs(title="Training time of All 5 Models",x="models",y="training time (s)")

p2 = ggplot(data=results,aes(x = as.factor(model), y = tm_test))+
  geom_bar(stat="identity")+
  theme_minimal()+
  labs(title="Testing time of All 5 Models",x="models",y="testing time (s)")
